import { TIMER_ACTIVITY_STATUS_EXERCISING, TIMER_ACTIVITY_STATUS_RESTING } from "./Timer";
import { DialogContentProps } from "./ui/Dialog";

type SessionStatus = typeof SESSION_STOPPED | typeof SESSION_STARTED | typeof SESSION_PAUSED;
