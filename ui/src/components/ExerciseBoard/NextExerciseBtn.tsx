...
export default function NextExerciseBtn({
  ...
  return (
    <a
      className="group ml-6 relative inline-block text-sm font-bold text-chinarose hover:text-ecru focus:outline-none focus:ring active:text-slate-500 transition-colors duration-200"
      href="/"
      onClick={(e) => {
        e.preventDefault();
        onNextExerciseClick();
